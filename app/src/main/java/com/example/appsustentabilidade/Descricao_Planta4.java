...
public class Descricao_Planta4 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_descricao_planta4);
        ...
        voltar.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent voltar = new Intent(Descricao_Planta4.this, MainActivity.class);
        ...
        home.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent home = new Intent(Descricao_Planta4.this, MainActivity.class);
                startActivity(home);
            }
        });
        ...
        tipos.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                Intent tipo = new Intent(Descricao_Planta4.this, Tipos.class);
                startActivity(tipo);
            }
        });
        ...
        perfil.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                Intent perfil = new Intent(Descricao_Planta4.this, Perfil.class);
